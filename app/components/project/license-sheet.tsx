...
function LicencePreview({ licence }: { licence: CatalogLicence }) {
  ...
  return (
    <div
      className="[&_a]:underline [&_a]:underline-offset-2 [&_h3]:font-semibold [&_h3]:text-base [&_p]:mt-2 first:[&_p]:mt-0"
    ...
    <li className="flex flex-col gap-2 py-3">
            ...
            <PreviewCardTrigger
              render={
                licence.url ? (
                  ...
                  <span className="font-medium text-sm" tabIndex={0} />
                )
              }
            >
              {licence.title}
      ...
      {confirming && !attached && (
        <p className="text-muted-foreground text-xs">
          By attaching, you agree to apply “{licence.title}” to this project.
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetPopup side="right" variant="inset" showBackdrop={false}>
        <SheetHeader>
          ...
          <SheetDescription>
            Content and text rights-of-use licences from the catalog. Hover a
            title to preview it; retired or superseded licences are marked.
          </SheetDescription>
          <InputGroup>
            <InputGroupInput
        ...
        <SheetPanel>
          {contentCatalog.length === 0 ? (
            <p className="py-4 text-muted-foreground text-sm">
              No content licences are available yet — the licence catalog has
              not been seeded. The rest of the project keeps working without
              one.
            </p>
          ) : results.length === 0 ? (
            <p className="py-4 text-muted-foreground text-sm">
