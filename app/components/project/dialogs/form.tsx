            ...
            <DialogPopup>
                <fetcher.Form
                    ...
                    <DialogPanel className="flex flex-col gap-4">
                        <input type="hidden" name="intent" value={editing ? "update-project" : "create-project"} />
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                {users.length === 0 ? (
                                    <p className="text-sm text-muted-foreground">
                                        No user profiles are available yet, so a project cannot be created. The user
                                        directory must be seeded first.
                                    </p>
                                ) : (
                                    <select
                                        id="project-creator"
