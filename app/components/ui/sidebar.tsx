...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-400 ease-[cubic-bezier(0.34,1.3,0.64,1)] motion-reduce:duration-200 motion-reduce:ease-linear",
      ...
      <div
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-400 ease-[cubic-bezier(0.34,1.3,0.64,1)] motion-reduce:duration-200 motion-reduce:ease-linear md:flex",
          side === "left"
